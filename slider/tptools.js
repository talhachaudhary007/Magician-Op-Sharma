! function() {
    ...
    _tpt.tEvtSimple = t => _tpt.is_mobile ? "mouseenter" == t ? "touchstart" : "mouseleave" == t ? "mouseleave" : "mousemove" == t ? "touchmove" : t : t, _tpt.tEvt = t => Array.isArray(t) ? t.map((t => _tpt.tEvtSimple(t))) : _tpt.tEvtSimple(t), _tpt.event = {
        ...
        convert: t => {
            ...
            if ("string" == typeof t) {
                ...
                if (t.includes("&") || t.includes("{") && t.includes('"'))
                    if (e = JSON.parse(t.replaceAll("&", '"')), e.orig ??= {
                            ...e.colors
        ...
        ease: t => {
            ...
            if (e = .01 * parseInt(e, 10) * 15, n = t.easing.split("."), n.length < 2) return {
                ...t.orig
            };
            if (r.sort(_tpt.sortPoints), n = _tpt.gradient.easing[n[0]][n[1]], null == n) return {
                ...t.orig
            };
            let i = r.length - 1,
                s = [];
